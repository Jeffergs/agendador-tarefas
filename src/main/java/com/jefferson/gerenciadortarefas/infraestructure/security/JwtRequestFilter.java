...
public class JwtRequestFilter extends OncePerRequestFilter {
    ...
    private final com.jefferson.gerenciadortarefas.infraestructure.security.JwtUtil jwtUtil;
    private final UserDetailsServiceImpl userDetailsService;

    // Construtor que inicializa as propriedades com instâncias fornecidas
    public JwtRequestFilter(com.jefferson.gerenciadortarefas.infraestructure.security.JwtUtil jwtUtil, UserDetailsServiceImpl userDetailsService) {
